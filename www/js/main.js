...
/**
 * Handles triggering the animations for each flower. 
 * @param {Base} frameEvent 
 */
...
/**
 * Preforms a hit test on the flowerGroup. returns the Plant object hit, or null
 * if nothing hit. 
 * @param {ToolEvent} eventPoint 
 */
